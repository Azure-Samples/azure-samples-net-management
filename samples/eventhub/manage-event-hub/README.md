...
products:
- azure
description: "This code samples will show you how to manage event hub using Azure SDK for .NET."
urlFragment: eventhub-manage-eventhub
---
# Getting started - Managing Event Hub using Azure .NET SDK

This code sample will show you how to manage Event Hub using Azure SDK for .NET.
...
```bash
cd samples/eventhub/manage-event-hub
```
...
## This sample shows how to do following operations to manage Event Hub
