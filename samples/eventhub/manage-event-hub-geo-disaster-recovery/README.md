...
products:
- azure
description: "This code samples will show you how to manage event hub geo disaster recovery pairing using Azure SDK for .NET."
urlFragment: eventhub-manage-eventhub-geo-recovery
---
# Getting started - Managing Event Hub Geo Disaster Recovery Pairing using Azure .NET SDK

This code sample will show you how to manage Event Hub Geo Disaster Recovery Pairing using Azure SDK for .NET.
...
```bash
cd samples/eventhub/manage-event-hub-geo-disaster-recovery
```
...
## This sample shows how to do following operations to manage Event Hub Events
