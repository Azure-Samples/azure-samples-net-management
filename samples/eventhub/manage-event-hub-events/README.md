...
products:
- azure
description: "This code samples will show you how to manage event hub events using Azure SDK for .NET."
urlFragment: eventhub-manage-eventhub-events
---
# Getting started - Managing Event Hub Events using Azure .NET SDK

This code sample will show you how to manage Event Hub Events using Azure SDK for .NET.
...
```bash
cd samples/eventhub/manage-event-hub-events
```
